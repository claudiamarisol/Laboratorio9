...
Nombre: <input type="text" name="nombre" value="<?php echo (isset($nombre))?$nombre:''; ?>"> Apellido: <input type="text" name="apellido" value="<?php echo (isset($apellido))?$apellido:'';
?>">
...
echo "<td><a href='index.php?id_estudiante=" . $row['id'] . "'>Seleccionar</a></td>"; echo "</tr>";
}
?>
</table>
</body>
